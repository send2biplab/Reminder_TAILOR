...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (bundle != null) {
            String type = bundle.getString("Type", "CUSTOMER");
...
//                    Log.e("datee----1",""+day);
                   ...
                   //     addContact(sharedpreferences1.getString(prefix, "")+""+dashboard_customer_name.getText().toString(),Reg_Mobile);
                        ...
                        db.allRecordInsert(Reg_Mobile,  ""+dashboard_customer_name.getText().toString(),order_date.getText().toString(),trailr_date.getText().toString(),delivery_date.getText().toString(),salesman_date.getText().toString(),type,remark_date.getText().toString(),date.getText().toString(),followup_date.getText().toString());
